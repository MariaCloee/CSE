...
class Car(Vehicle):    # super = looking up   sub = looking down
    def __init__(self, seat, hp):
        super(Car, self).__init__('engine', 'steering wheel', seat)    # Ctrl + P makes the yellow thing above appear
        self.horsepower = hp
...
test_car = Car(4, 9001)         # You get every method above but not below
